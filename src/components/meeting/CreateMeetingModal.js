...
const CreateMeetingModal = ({ isVisible, onClose, onAddMeeting }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg p-8 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-slate-800">Create Meeting</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-4 pt-4">
            ...
            <button type="submit" className="py-2 px-4 rounded-lg bg-teal-500 text-white font-semibold hover:bg-teal-600">Create Meeting</button>
          </div>
        </form>
      </div>
    </div>
